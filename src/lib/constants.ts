...
export const API_BASE_URL = 'https://deprecatedapis.tts.quest/v2/';
export const API_URL = `${API_BASE_URL}voicevox/audio/`;
export const API_POINT_URL = `${API_BASE_URL}api/`;
